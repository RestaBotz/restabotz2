...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 × ${prefix}sellemas
 × ${prefix}selldiamond`
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: thumbrpg }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
「 PROFILE 」
 ...
 • Xp :  ${getLevelingXp(sender)}/${reqXp}
「 RPG GAME 」`
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgjoinrpg }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
addDm(sender, d)
        ...
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgslime }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imggoblin }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdevil }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgbehemoth }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemon }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemonking }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `Created By By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Rpg Game By RestaBotz ", sectionnya, { quoted: m})
break
case 'slime':
case 'killslime':
...
➥ ${ya}Wit${ya} : ${wit}
➥ ${ya}Wita${ya} : ${wita}
─〇` , `Created By RestaBotz`, [
{"urlButton": {"displayText": "MyYoutube","url": `https://www.youtube.com/channel/UC5upm_XOxH6bvb-1pSbXYHw`}},
{"callButton": {"displayText": "Myowner","phoneNumber": `+62 813-2860-8503`}},
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By RestaBotz`, global.thumb, btn)
}
break
case 'userkirbotz':{
...
kirbotz.send5ButImg(i, junn, `Created By RestaBotz`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `Created By RestaBotz`, buffer, butoon)
...
hydratedFooterText: 'Created By RestaBotz',
hydratedButtons: [{
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/RestaBotz'
}
},
{
urlButton: {
displayText: 'MyOwner',
url: 'https://wa.me/6281328608503'
}
},
...
imageMessage: message.imageMessage,
hydratedContentText: pll,
hydratedFooterText: 'Create By RestaBotz',
hydratedButtons: [{
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/RestaBotz'
...
var button = [
        ...
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n • Tempat  ${ad}\n • MONEY : $${money}\n • EXP : ${adven}Xp`
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `Rpg Game By RestaBotz`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
...
title: a.title, description: `Channel: ${a.author.name} | Durasi: ${a.duration}`, rowId: `${prefix}play ${a.url}`
    ...
    const button = {
        ...
        footerText: `Create By RestaBotz`,
